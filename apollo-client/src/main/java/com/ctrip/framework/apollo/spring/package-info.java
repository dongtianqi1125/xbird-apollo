 ...
 * </p>
 * <ul>
 * <li>&lt;apollo:config namespaces="someNamespace"/&gt; to inject configurations from Apollo into
 * Spring Property Sources so that placeholders like ${someProperty} and @Value("someProperty") are
 * supported.</li>
 * </ul>
 * <p>
 ...
 * </p>
 * <ul>
 * <li>@EnableApolloConfig(namespaces={"someNamespace"}) to inject configurations from Apollo into
 * Spring Property Sources so that placeholders like ${someProperty} and @Value("someProperty") are
 * supported.</li>
 * </ul>
 *
