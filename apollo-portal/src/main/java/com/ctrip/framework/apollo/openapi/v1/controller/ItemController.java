...
public class ItemController {
  ...
  public OpenItemDTO createItem(@PathVariable String appId, @PathVariable String env,
    ...
    ItemDTO createdItem =
        itemService.createItem(appId, Env.fromString(env), clusterName, namespaceName, toCreate);
  ...
  public void updateItem(@PathVariable String appId, @PathVariable String env,
    ...
    RequestPrecondition.checkArguments(
        !StringUtils.isContainEmpty(item.getKey(), item.getValue(),
    ...
    ItemDTO toUpdateItem =
        itemService.loadItem(Env.fromString(env), appId, clusterName, namespaceName, item.getKey());
  ...
  public void deleteItem(@PathVariable String appId, @PathVariable String env,
      @PathVariable String clusterName, @PathVariable String namespaceName,
      @PathVariable String key, @RequestParam String operator, HttpServletRequest request) {
    ...
    ItemDTO toDeleteItem =
        itemService.loadItem(Env.fromString(env), appId, clusterName, namespaceName, key);
