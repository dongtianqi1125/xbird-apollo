...
public class DefaultRoleInitializationService implements RoleInitializationService {
  ...
  public void initAppRoles(App app) {
    ...
    rolePermissionService.assignRoleToUsers(RoleUtils.buildNamespaceRoleName(appId,
        ConfigConsts.NAMESPACE_APPLICATION, RoleType.MODIFY_NAMESPACE), Sets.newHashSet(operator),
        operator);
    rolePermissionService.assignRoleToUsers(RoleUtils.buildNamespaceRoleName(appId,
        ConfigConsts.NAMESPACE_APPLICATION, RoleType.RELEASE_NAMESPACE), Sets.newHashSet(operator),
        operator);
  ...
  private void createAppMasterRole(String appId, String operator) {
    Set<Permission> appPermissions = FluentIterable
        .from(Lists.newArrayList(PermissionType.CREATE_CLUSTER, PermissionType.CREATE_NAMESPACE,
    ...
    Set<Long> appPermissionIds = FluentIterable.from(createdAppPermissions)
